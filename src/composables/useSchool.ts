...
export function useSchool() {
  ...
  const supportiveSchoolAward = computed(() => {
    ...
    return {
      ...
      rate:
        SupportiveSchoolAward[school.value.supportiveSchoolAward as SupportiveSchoolAwardKeys] ??
        '',
  ...
  const studentAttainmentRating = computed(() => {
    ...
    return {
      ...
      rate:
        StudentAttainmentRating[
          school.value.studentAttainmentRating as StudentAttainmentRatingKeys
        ] ?? '',
  ...
  const cultureClimateRating = computed(() => {
    ...
    return {
      ...
      rate:
        CultureClimateRating[school.value.cultureClimateRating as CultureClimateRatingKeys] ?? '',
  ...
  const creativeSchoolCertification = computed(() => {
    ...
    return {
      ...
      rate:
        CreativeSchoolCertification[
          school.value.creativeSchoolCertification as CreativeSchoolCertificationKeys
        ] ?? '',
