...
export const DashboardCardKeys: { [key: string]: DashboardCardKey } = {
...
export const DashboardInfoModalContents = {
  [DashboardCardKeys.schoolCategories as string]: {
  ...
  [DashboardCardKeys.schoolTypes as string]: {
  ...
  [DashboardCardKeys.blueRibbonAward as string]: {
  ...
  [DashboardCardKeys.chronicTruancy as string]: {
  ...
  [DashboardCardKeys.mobilityRate as string]: {
